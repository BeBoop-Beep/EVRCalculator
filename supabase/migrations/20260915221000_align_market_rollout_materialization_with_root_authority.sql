...
-- Both RPCs mutate publication state and are service-only operational surfaces.
-- The candidate RPC was already hardened; the historical finalizer retained
-- PostgreSQL's default PUBLIC execute grant. Close that stale boundary now.
