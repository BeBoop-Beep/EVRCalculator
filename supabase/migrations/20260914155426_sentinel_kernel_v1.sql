-- inDex Sentinel kernel persistence migration.
-- Applied to production as migration version 20260914155426.
-- Access model: server-side Sentinel/service_role only; no client-role access.
...
COMMENT ON TABLE public.sentinel_recovery_attempts IS
    'Future bounded recovery audit trail. Recovery remains disabled until separately approved.';
