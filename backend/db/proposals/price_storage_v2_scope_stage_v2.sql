-- REVIEW-ONLY SOURCE: production has a forward migration derived from this contract.
-- Date-safe successor to the already-applied canonical_asof_scope_split_v1 stage.
-- V1 remains untouched for historical auditability.
BEGIN;
