...
def _product_availability(row: Mapping[str, Any], metrics: Mapping[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "reason": reason,
        "financialRipStatus": _optional_str(row.get("financial_rip_v4_status")),
        "financialRipRankable": bool(row.get("financial_rip_v4_rankable")),
        "overallRipRankable": bool(row.get("overall_rip_v10_rankable")),
...
def _product_decision_row(row: Mapping[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        **metrics,
        ...
        "financialRipVersion": _optional_str(row.get("financial_rip_v4_version")),
        ...
        "overallRipScore": _optional_float(row.get("overall_rip_v10_score")),
        "overallRipVersion": _optional_str(row.get("overall_rip_v10_version")),
        "overallRipRankable": bool(row.get("overall_rip_v10_rankable")),
