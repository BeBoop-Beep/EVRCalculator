-- Fix Set Value hits rollup after the market-day timezone migration.
--
-- The 038 migration switched Set Value history to America/Phoenix market days.
-- This follow-up preserves that behavior while fixing hits_aggregated so priced
-- hit cards are not multiplied by every canonical card in the set.
