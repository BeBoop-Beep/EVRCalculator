...
), unranked_selected AS NOT MATERIALIZED (
...
), top_n_ranked AS NOT MATERIALIZED (
...
), selected_with_previous AS NOT MATERIALIZED (
 SELECT selected.*,
...
'Candidate reducing redundant expanded-panel materialization.';
