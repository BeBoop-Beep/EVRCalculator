...
BEGIN
    ...
    LOOP
        ...
        BEGIN
            ...
            v_interval_result := public.sync_pokemon_market_price_intervals_v2_shadow_set_from_date(
                v_job.set_id,
                v_job.market_date
            );
...
REVOKE ALL ON FUNCTION public.process_price_storage_v2_shadow_queue(integer)
    FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.process_price_storage_v2_shadow_queue(integer)
    TO service_role;
