"""Project 17D.2 early regular SWSH controlled persistence preflight (read-only).
...
DEFAULT_JSON_PATH = Path("logs/audits/swsh_early_regular_controlled_persistence_preflight.json")

TARGET_ALLOWLIST = ("swsh1", "swsh2", "swsh3")
...
def run_swsh_early_regular_controlled_persistence_preflight(
    *,
    ...
    payload: Dict[str, Any] = {
        "meta": {
            ...
            "project": "17D.2",
            "script": "audit_swsh_early_regular_controlled_persistence_preflight.py",
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Early regular SWSH controlled persistence preflight (read-only)")
...
def main() -> int:
    ...
    try:
        payload = run_swsh_early_regular_controlled_persistence_preflight(
