    ...
    for left_name, right_name in comparisons:
        ...
        for key in sorted(set(left_rows).intersection(right_rows)):
            ...
            fields = (
                ...
                ("current-price mismatch", "currentPrice", "current_price", 0.005),
                ("amount mismatch", "changeAmount", "change_amount", 0.005),
                ("percentage mismatch", "changePercent", "change_percent", 0.01),
