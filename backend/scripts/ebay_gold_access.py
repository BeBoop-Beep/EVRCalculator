...
FILES={'DEVELOPMENT':'ebay_gold_development.csv','VALIDATION':'ebay_gold_validation.csv','FINAL_BLIND_TEST':'ebay_gold_final_blind.csv','PRECISION_BLIND':'ebay_d3_precision_blind.csv','COVERAGE_BLIND':'ebay_d3_coverage_blind.csv'}
def load_partition(partition, purpose='matcher_development', freeze_manifest=None):
    ...
    if partition in {'PRECISION_BLIND','COVERAGE_BLIND'} and purpose!='human_review':
