...
#: The at-a-glance windows the constituent inspector offers. These deliberately
#: reuse the shared market-index window resolver so "6M", "1Y", and
#: "SinceTracking" mean exactly the same thing here as everywhere else.
