...
class SetPitchBlackConfig(BaseSetConfig):
    ...
    PULL_RATE_MAPPING = {
        ...
        'common' : 0, # 4/84 (there are 4 commons in each pack with 84 total commons is in the set)
        'uncommon': 0, # 3/69 (there are 3 uncommons in each pack with 69 total uncommons in the set)
        'rare': 0,
        'double rare': 48,
