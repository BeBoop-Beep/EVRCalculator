...
class SetRebelClashConfig(BaseSetConfig):
    ...
    # - no Amazing Rare, Trainer Gallery, Radiant, or VSTAR runtime buckets in swsh2.
    ...
    SLOT_SCHEMA_SOURCE_CONFIDENCE = {
        ...
        "source_caveat": (
            ...
            "swsh2 keeps broad buckets only; unsupported specialty rows remain reference-only."
        ),
        "blocking_reasons": [],
    }
    ...
    REBEL_CLASH_PULL_RATE_REFERENCE_SOURCES = [
        {
            "source_id": "swsh2_elite_fourum_primary_2736_2020_07_18",
            "source_name": "Elite Fourum pull-rate thread (Rebel Clash)",
            ...
            "notes": (
                "Primary community empirical source for swsh2 with 2,736 packs in the 2020-07-18 dataset. "
                "Sample-based evidence and not official Pokemon-published odds."
            ),
        },
        {
            "source_id": "swsh2_thepricedex_cross_reference_2026_05",
            "source_name": "ThePriceDex Rebel Clash pull-rate cross-reference",
            "source_url": "https://www.thepricedex.com/set/swsh2/rebel-clash/pull-rates",
        ...
        {
            "source_id": "swsh2_elite_fourum_rarity_guide_supplement",
    ...
    REBEL_CLASH_PULL_RATE_REFERENCE_BUCKET_EVIDENCE = [
        ...
        },
        {
            ...
            "used_in_runtime": False,
            "source_ids": [],
            "caveat": "Not a swsh2 runtime bucket.",
        },
        {
            ...
            "used_in_runtime": False,
            "source_ids": [],
            "caveat": "swsh2 predates Trainer Gallery runtime modeling.",
        },
        {
            ...
            "used_in_runtime": False,
            "source_ids": [],
            "caveat": "swsh2 predates Radiant and VSTAR runtime buckets.",
        },
    ]
