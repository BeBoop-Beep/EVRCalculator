...
class SetGenerationsConfig(BaseSetConfig):
    ...
    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/1728/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/1728/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
