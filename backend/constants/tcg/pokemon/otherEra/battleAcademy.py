...
class SetBattleAcademyConfig(BaseSetConfig):
    ...
    TCGPLAYER_SET_ID = '2686'
    TCGPLAYER_SET_NAME = 'Battle Academy'

    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/2686/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/2686/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
