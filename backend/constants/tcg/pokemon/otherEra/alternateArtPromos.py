...
class SetAlternateArtPromosConfig(BaseSetConfig):
    ...
    TCGPLAYER_SET_ID = '1938'
    TCGPLAYER_SET_NAME = 'Alternate Art Promos'

    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/1938/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/1938/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
