...
class SetXyTrainerKitPikachuLibreAndSuicuneConfig(BaseSetConfig):
    ...
    TCGPLAYER_SET_ID = '1796'
    TCGPLAYER_SET_NAME = 'XY Trainer Kit: Pikachu Libre & Suicune'

    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/1796/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/1796/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
