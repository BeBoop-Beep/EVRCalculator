...
class SetProfessorProgramPromosConfig(BaseSetConfig):
    ...
    TCGPLAYER_SET_ID = '2332'
    TCGPLAYER_SET_NAME = 'Professor Program Promos'

    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/2332/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/2332/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
