...
class SetDpTrainerKitManaphyAndLucarioConfig(BaseSetConfig):
    ...
    TCGPLAYER_SET_ID = '1541'
    TCGPLAYER_SET_NAME = 'DP Trainer Kit: Manaphy & Lucario'

    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/1541/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/1541/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
