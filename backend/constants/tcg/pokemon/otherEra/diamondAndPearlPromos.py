...
class SetDiamondAndPearlPromosConfig(BaseSetConfig):
    SET_NAME = 'Diamond and Pearl Promos'
    ...
    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/1421/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/1421/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
