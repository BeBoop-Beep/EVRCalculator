...
class SetXyTrainerKitBisharpAndWigglytuffConfig(BaseSetConfig):
    ...
    TCGPLAYER_SET_ID = '1533'
    TCGPLAYER_SET_NAME = 'XY Trainer Kit: Bisharp & Wigglytuff'

    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/1533/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/1533/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
