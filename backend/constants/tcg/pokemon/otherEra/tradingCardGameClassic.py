...
class SetTradingCardGameClassicConfig(BaseSetConfig):
    SET_NAME = 'Trading Card Game Classic'
    ...
    TCGPLAYER_SET_ID = '23323'
    TCGPLAYER_SET_NAME = 'Trading Card Game Classic'

    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/23323/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/23323/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
