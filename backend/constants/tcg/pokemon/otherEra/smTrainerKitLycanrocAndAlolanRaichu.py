...
class SetSmTrainerKitLycanrocAndAlolanRaichuConfig(BaseSetConfig):
    ...
    TCGPLAYER_SET_ID = '2069'
    TCGPLAYER_SET_NAME = 'SM Trainer Kit: Lycanroc & Alolan Raichu'

    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/2069/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/2069/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
