...
class SetXyTrainerKitSylveonAndNoivernConfig(BaseSetConfig):
    ...
    TCGPLAYER_SET_ID = '1532'
    TCGPLAYER_SET_NAME = 'XY Trainer Kit: Sylveon & Noivern'

    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/1532/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/1532/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
