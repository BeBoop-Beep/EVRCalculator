...
class SetDeckExclusivesConfig(BaseSetConfig):
    ...
    TCGPLAYER_SET_ID = '1840'
    TCGPLAYER_SET_NAME = 'Deck Exclusives'

    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/1840/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/1840/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
