...
class SetBestOfPromosConfig(BaseSetConfig):
    ...
    TCGPLAYER_SET_ID = '1455'
    TCGPLAYER_SET_NAME = 'Best of Promos'

    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/1455/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/1455/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
