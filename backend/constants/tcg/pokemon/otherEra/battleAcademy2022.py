...
class SetBattleAcademy2022Config(BaseSetConfig):
    SET_NAME = 'Battle Academy 2022'
    ...
    TCGPLAYER_SET_ID = '3051'
    TCGPLAYER_SET_NAME = 'Battle Academy 2022'

    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/3051/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/3051/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
