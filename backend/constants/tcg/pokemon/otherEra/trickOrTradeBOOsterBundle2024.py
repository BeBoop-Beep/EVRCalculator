...
class SetTrickOrTradeBOOsterBundle2024Config(BaseSetConfig):
    ...
    TCGPLAYER_SET_ID = '23561'
    TCGPLAYER_SET_NAME = 'Trick or Trade BOOster Bundle 2024'

    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/23561/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/23561/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
