...
class SetSveScarletAndVioletEnergiesConfig(BaseSetConfig):
    SET_NAME = 'SVE: Scarlet & Violet Energies'
    ...
    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/24382/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/24382/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
