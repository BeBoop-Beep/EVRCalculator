...
class SetCountdownCalendarPromosConfig(BaseSetConfig):
    SET_NAME = 'Countdown Calendar Promos'
    ...
    TCGPLAYER_SET_ID = '2155'
    TCGPLAYER_SET_NAME = 'Countdown Calendar Promos'

    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/2155/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/2155/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
