...
class SetPikachuWorldCollectionPromosConfig(BaseSetConfig):
    ...
    TCGPLAYER_SET_ID = '2205'
    TCGPLAYER_SET_NAME = 'Pikachu World Collection Promos'

    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/2205/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/2205/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
