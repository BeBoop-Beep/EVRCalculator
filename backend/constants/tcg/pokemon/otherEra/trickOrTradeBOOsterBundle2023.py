...
class SetTrickOrTradeBOOsterBundle2023Config(BaseSetConfig):
    ...
    TCGPLAYER_SET_ID = '23266'
    TCGPLAYER_SET_NAME = 'Trick or Trade BOOster Bundle 2023'

    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/23266/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/23266/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
