...
class SetBattleAcademy2024Config(BaseSetConfig):
    ...
    TCGPLAYER_SET_ID = '23520'
    TCGPLAYER_SET_NAME = 'Battle Academy 2024'

    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/23520/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/23520/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
