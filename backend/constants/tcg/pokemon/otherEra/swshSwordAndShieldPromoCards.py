...
class SetSwshSwordAndShieldPromoCardsConfig(BaseSetConfig):
    SET_NAME = 'SWSH: Sword & Shield Promo Cards'
    ...
    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/2545/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/2545/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
