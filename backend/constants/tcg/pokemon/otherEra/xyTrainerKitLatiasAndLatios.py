...
class SetXyTrainerKitLatiasAndLatiosConfig(BaseSetConfig):
    SET_NAME = 'XY Trainer Kit: Latias & Latios'
    ...
    TCGPLAYER_SET_ID = '1536'
    TCGPLAYER_SET_NAME = 'XY Trainer Kit: Latias & Latios'

    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/1536/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/1536/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
