...
class SetHgssTrainerKitGyaradosAndRaichuConfig(BaseSetConfig):
    ...
    TCGPLAYER_SET_ID = '1540'
    TCGPLAYER_SET_NAME = 'HGSS Trainer Kit: Gyarados & Raichu'

    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/1540/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/1540/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
