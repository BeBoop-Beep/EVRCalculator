...
class SetWorldChampionshipDecksConfig(BaseSetConfig):
    ...
    TCGPLAYER_SET_ID = '2282'
    TCGPLAYER_SET_NAME = 'World Championship Decks'

    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/2282/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/2282/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
