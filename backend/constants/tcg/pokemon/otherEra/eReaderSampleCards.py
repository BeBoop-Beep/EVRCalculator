...
class SetEReaderSampleCardsConfig(BaseSetConfig):
    SET_NAME = 'e-Reader Sample Cards'
    ...
    TCGPLAYER_SET_ID = '24493'
    TCGPLAYER_SET_NAME = 'e-Reader Sample Cards'

    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/24493/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/24493/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
