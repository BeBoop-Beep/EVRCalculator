...
class SetFirstPartnerPackConfig(BaseSetConfig):
    SET_NAME = 'First Partner Pack'
    ...
    TCGPLAYER_SET_ID = '2776'
    TCGPLAYER_SET_NAME = 'First Partner Pack'

    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/2776/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/2776/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
