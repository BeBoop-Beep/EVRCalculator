...
class SetBwTrainerKitExcadrillAndZoroarkConfig(BaseSetConfig):
    ...
    TCGPLAYER_SET_ID = '1538'
    TCGPLAYER_SET_NAME = 'BW Trainer Kit: Excadrill & Zoroark'

    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/1538/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/1538/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
