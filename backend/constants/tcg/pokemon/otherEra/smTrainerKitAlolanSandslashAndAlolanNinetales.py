...
class SetSmTrainerKitAlolanSandslashAndAlolanNinetalesConfig(BaseSetConfig):
    ...
    TCGPLAYER_SET_ID = '2208'
    TCGPLAYER_SET_NAME = 'SM Trainer Kit: Alolan Sandslash & Alolan Ninetales'

    CARD_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/2208/cards/?rows=5000&productTypeID=1'
    SEALED_DETAILS_URL = 'https://infinite-api.tcgplayer.com/priceguide/set/2208/cards/?rows=5000&productTypeID=25'
    PRICE_ENDPOINTS = {}
