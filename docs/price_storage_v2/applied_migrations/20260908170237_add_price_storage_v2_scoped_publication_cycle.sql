...
IS 'Scoped coordinator using date-safe v2 staging. Requires explicit enabled release gate; no cron attachment. Atomic invocation stages and publishes independent member/root destinations or rolls back.';
