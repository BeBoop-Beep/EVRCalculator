...
export default function EvRepresentativenessSection({ summary, percentiles, evRepresentativeness = null, calculationRunId = null, headingId, summaryOnly = false }) {
