...
export default function SevenDayMarketMoversTicker({ entry, maxItems = 10, scope = "set", status = "success", error, viewAllHref = "#", onRetry }) {
  ...
  return <div className={`flex ${containerHeightClass} min-w-0 items-center gap-2 rounded-xl border border-[var(--border-subtle)] py-1 pl-3 pr-2 max-desk:rounded-none max-desk:border-0 max-desk:px-0`}>
