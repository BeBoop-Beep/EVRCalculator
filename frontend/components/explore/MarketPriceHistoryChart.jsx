...
import { toFiniteNumber } from "@/components/pokemon/set-page/Market/setMarketMobileModel.mjs";

// ---------------------------------------------------------------------------
// Canonical single-series market-price-history chart shared by Market surfaces.
//
...
export default function MarketPriceHistoryChart({
  points,
  valueKey = "value",
