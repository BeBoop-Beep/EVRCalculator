...
export default function MarketExplorerExactItemPicker({ selectedItems = [], onChange, open = true, onClose, showClose = true, onCancelEdit, onBuild, onSaveAsNew, executionLocked = false, buildLabel = "Build Market", buildStatus = "idle", buildMessage = "" }) {
