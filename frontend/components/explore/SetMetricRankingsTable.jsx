...
const CONFIG = {
  financial: { title: "Financial RIP rankings", description: "Which sets have the strongest monetary opening profile?", read: readFinancialSetRanking, columns: ["Expected Value", "Typical Opening", "Modeled Return", "Chance to Beat Cost"] },
