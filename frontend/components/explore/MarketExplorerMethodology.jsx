...
const HELP_VARIANTS = "Vintage editions are separate Set markets rather than one blended market. For example, Jungle — 1st Edition and Jungle — Unlimited have separate Set Values, Market Index histories and constituent baskets; Base also separates Shadowless. Within each market, physically distinct card forms keep their own identity and price.";
