...
export default function MarketExplorerContextRanking({ market, timeframe, canUse, onUpgrade }) {
  ...
  return <section data-market-context-ranking className="border-t border-[var(--border-subtle)] px-3 py-3 sm:px-4" aria-labelledby="market-context-ranking-heading">
    <h2 id="market-context-ranking-heading" className="text-[16px] font-semibold text-[var(--text-primary)]">Selected Set Analysis</h2>
    <p className="text-[11px] text-[var(--text-secondary)]">Analyze {market.label}</p>
