// Canonical analytical-action treatment. This is the exact interaction family
// established by the Market Overview "Open Market Explorer" control.
export const ANALYTICAL_ACTION_CLASS = [
  "inline-flex min-h-9 flex-none items-center gap-1.5 whitespace-nowrap rounded-md",
...
export const ANALYTICAL_ROW_LINK_CLASS = [
