...
export function ChaseEfficiencyRouteCostFigure() {
  const max = 16.25;
  return <MediaFigure caption="Frozen August 27, 2026 production prices. “Best verified” means the cheapest current cost per modeled random pack among supported products with known composition. It does not imply that opening is profitable."><div className="space-y-6" role="img" aria-label="Loose pack and best verified pack-equivalent costs for five Pokémon sets">
