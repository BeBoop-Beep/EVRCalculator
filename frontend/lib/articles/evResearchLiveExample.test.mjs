...
const evidence = { contractVersion: "pokemon-set-simulation-evidence-v1", setId: "set-a", calculationRunId: "run-A", distributionBins: [{ min: 0, max: 1, count: 1 }], thresholdBins: [], percentiles: [{ percentile: 50, value: 2 }], summary: { meanValue: 8 } };
