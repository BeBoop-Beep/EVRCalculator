import { normalizePokemonSetInsightsCriticalPayload as normalizeCriticalPayload } from "./pokemonSetInsightsCriticalNormalizer.mjs";

export function normalizePokemonSetInsightsCriticalPayload(payload) {
  return normalizeCriticalPayload(payload);
}
