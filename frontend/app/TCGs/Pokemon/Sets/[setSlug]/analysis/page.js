...
import { buildTcgSetHrefFromSlug, findTargetBySetSlug, toSetSlug } from "@/lib/explore/ripStatisticsRouting";
...
export default async function PokemonSetAnalysisPage({ params }) {
  ...
  const selectedTarget = findTargetBySetSlug(targets, String(setSlug || "").trim());
