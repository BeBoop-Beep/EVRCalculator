import { ArticleJsonLd, ArticleShell, Citation, EvDistributionDiagram, H2, ReferenceList } from "@/components/articles/ArticlePrimitives";
...
const references = [
  { id: "ref-openstax-probability-mean", href: "https://openstax.org/books/introductory-statistics-2e/pages/4-key-terms", citation: "OpenStax. Introductory Statistics 2e. Chapter 4: Key Terms.", note: "Defines Expected Value as the long-run mean of a probability distribution." },
  { id: "ref-openstax-center", href: "https://openstax.org/books/introductory-statistics-2e/pages/2-5-measures-of-the-center-of-the-data", citation: "OpenStax. Introductory Statistics 2e. Section 2.5: Measures of the Center of the Data.", note: "Distinguishes the mean and median and explains the median’s resistance to extreme values." },
];
...
export default function Page() { return <ArticleShell category="Analysis & Guides" title={title} deck="EV answers a real question. The problem is that it is usually not the only question a person opening packs meant to ask." lastUpdated={registeredArticle.lastUpdated} related={related("financial", "simulation", "validation")}>
  ...
  <p>I started with Expected Value because financially it is the obvious number to calculate. Expected Value is the long-run mean of a probability distribution, as summarized by <Citation href="https://openstax.org/books/introductory-statistics-2e/pages/4-key-terms">OpenStax</Citation>. If a pack has an EV of $4, then across a very large number of openings the modeled average value is $4 per pack. I still show it prominently because that is useful information.</p>
  ...
  <p>P50 is the median. Half of simulated openings finish above it and half finish below it. The distinction between mean and median, including the median’s resistance to extreme values, follows the standard definitions explained by <Citation href="https://openstax.org/books/introductory-statistics-2e/pages/2-5-measures-of-the-center-of-the-data">OpenStax</Citation>. On the site I call P50 Typical Opening because it is more useful to most people than “50th percentile simulated return.”</p>
