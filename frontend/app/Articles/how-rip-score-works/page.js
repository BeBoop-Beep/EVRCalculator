...
const description = "How RIP Score synthesizes Financial RIP, Chase Accessibility, and Collector Appeal into a relative comparison of Pokémon pack openings.";
...
export default async function HowRipScoreWorksArticle() {
  ...
  return <ArticleShell category="Methodology" title={title} deck="RIP Score brings financial outcomes, chase accessibility, and collector appeal into one relative comparison. It is not a promise that your next pack makes money." lastUpdated={registeredArticle.lastUpdated} related={related("financial", "chaseAccessibility", "collector", "simulation")}>
    ...
    <p>RIP Score is useful for one job: ordering the supported choices in front of you using a consistent opening model. It is not financial advice, a forecast, or a prediction of your next pack.</p>
    <H2>References</H2>
    <p>RIP Score and its synthesis of Financial RIP, Chase Accessibility, and Collector Appeal are original inDex methodology. These references support the standard Expected Value, probability-distribution, and Monte Carlo concepts underneath the analysis; they do not externally validate the RIP score or disclose its protected construction.</p>
