...
export default async function Page() {
  ...
  return <ArticleShell category="Methodology" title={title} deck="One pack gives you a story. A million modeled packs give us a distribution we can actually measure." related={related("validation", "rip", "ev")}>
    ...
    <p>Then it does the same thing again. The production runner requests 1,000,000 openings per supported set and stores the value of each opening long enough to compute the outcome profile and Financial RIP inputs.</p>
