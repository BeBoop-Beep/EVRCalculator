...
export default function Page() { return <ArticleShell category="Methodology" title={title} deck="A pack can be financially efficient and still contain nothing you care about. That is a different problem, so I measure it separately." lastUpdated={registeredArticle.lastUpdated} related={related("rip", "financial", "simulation")}>
  ...
  <p>Overall RIP keeps three distinct perspectives because “worth opening” contains more than one question. Financial RIP describes money outcomes, Chase Accessibility describes how reachable important collectible values are, and Collector Appeal describes whether the modeled roster contains things collectors tend to want. None is a promise about what you personally should like.</p>
  <H2>References</H2>
