      ...
      */}
      ...
      <div data-rankings-data-surface className="w-full">
        ...
        <div data-mobile-section>
          <ProductFamilyRankingsClient targets={leaderboardTargets} productFamilyRankings={payload?.productFamilyRankings} initialOverallProductRankings={initialOverallProductRankings} openingEconomics={openingEconomics} eraSetStrength={payload?.eraSetStrengthV1} rankingsMarketDate={payload?.meta?.comparisonSnapshots?.currentMarketDate || null} loadError={rankingsLoadError} />
        </div>
      </div>
    </div>
  );
