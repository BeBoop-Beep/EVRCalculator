...
export const EXPLORE_RANKING_MODES = {
  ...
  upside: {
    ...
    subtitle: "Sets ranked by how strong the high-end outcomes are when the pack hits.",
    tooltip: "Sets ranked by how strong the high-end outcomes are when the pack hits.",
    scoreLabel: "BIG HIT UPSIDE",
    tierLabel: "TIER",
    scoreField: "p95_value_to_cost_ratio",
    rankField: "p95_value_to_cost_rank",
    tierField: "p95_value_to_cost_tier",
    scoreFormat: "ratio",
    description: "Big Hit Upside measures the 95th percentile value-to-cost ratio.",
  },
};
