...
export const FRIENDLY_METRIC_LABELS = {
  ...
  "Median-to-Cost Ratio": "Typical Opening",
  "P95-to-Cost Ratio": "Strong Upside",
  "P95 Value / Cost Ratio": "Strong Upside",
  "P99-to-Cost Ratio": "Jackpot Upside",
  "P99 Value / Cost Ratio": "Jackpot Upside",
  ...
  "Typical Pack": "Typical Opening",
  "Typical Pack Value": "Typical Opening",
...
const METRIC_TOOLTIP_ALIASES = {
  ...
  "Strong Upside": "P95-to-Cost Ratio",
  "Jackpot Upside": "P99-to-Cost Ratio",
  ...
  "Typical Opening": "Typical Opening",
  "Bad Pack Floor Value": "Bad Pack Floor Value",
...
export const METRIC_TOOLTIP_EXPLANATIONS = {
  ...
  "P95-to-Cost Ratio": buildMetricTooltip({
    meaning: "Strong Upside is the P95 threshold compared with the current pack market price.",
  ...
  "P99-to-Cost Ratio": buildMetricTooltip({
    meaning: "Jackpot Upside is the top-1% threshold, beginning at the 99th percentile simulated outcome.",
  ...
  "Typical Opening": buildMetricTooltip({
    meaning: "Typical Opening represents the median (P50) simulated pack outcome.",
    impact: "Context signal",
    direction: "Higher is better",
  ...
  "Typical Opening (P50) vs Cost": buildMetricTooltip({
    meaning: "Typical Opening (P50) vs Cost is the median simulated pack value divided by the current pack market price.",
    impact: "Direct Profit score input",
    direction: "Higher is better",
  ...
  "Strong Upside": buildMetricTooltip({
    meaning: "Strong Upside is the P95 threshold compared with the current pack market price.",
    impact: "Context signal",
    direction: "Higher is better",
    interpretation: "Values above 1.00 mean the P95 outcome beats pack cost. This is upper-end upside, not average profitability.",
  }),
  "Jackpot Upside": buildMetricTooltip({
    meaning: "Jackpot Upside is the top-1% threshold, beginning at P99, compared with pack cost.",
    impact: "Context signal",
    direction: "Higher is better",
